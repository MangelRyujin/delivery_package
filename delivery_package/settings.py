"""
Django settings for delivery_package project.
...
ROOT_URLCONF = 'delivery_package.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'libraries': {
                'user_tags': 'apps.account.templatetags.user_tags',
                'float_str': 'apps.account.templatetags.custom_tags'
            },
...
WSGI_APPLICATION = 'delivery_package.wsgi.application'
